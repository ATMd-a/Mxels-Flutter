...
import 'package:Mxels/routes/app_routes.dart'; // Import the routes file
...
class TextAndButtonAction extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    context,
    MaterialPageRoute(
    builder: (context) => PhoneNumberScreen()), // Updated to use the imported screen
    );
    },
    style: ElevatedButton.styleFrom(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => SignupScreen()), // Updated to use the imported screen
              );
            },
            child: const Text(
              'ORDER AS GUEST',
